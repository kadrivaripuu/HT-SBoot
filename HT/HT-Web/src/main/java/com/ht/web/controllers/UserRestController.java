...
public class UserRestController {
	...
	public @ResponseBody List<User> findAll() {
		List users = (List<User>) userService.findAllUsers();
		return users;
	...
	public @ResponseBody ResponseBean<String> moduleProcess(@RequestBody UserDto userDto) {
	...
	@RequestMapping(value = "/{id}", method = RequestMethod.GET, 
			produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody ResponseBean<UserDto> find(@PathVariable Long id) {
	...
	@RequestMapping(value = "/delete/{id}", method = RequestMethod.GET, 
			produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody ResponseBean<UserDto> userDelete(@PathVariable Long id) {
